#Simulation Wrigth-Fisher population with subpopulations and genetic drift 22/7/2012
# N Efective population size -> number individuals
# N.gen -> number of generations
# N.markers -> number of dominant markers to simulate
# N.chrom -> number of chromosomes (is possible polyploids?)
# pop -> number of subpopulations
# apa & apb -> values of beta distributions related to mutation and migration see Wrigth 1931

drift.n<-function(N,n,N.gen,N.markers,pop,apa=0.5,apb=0.5){
